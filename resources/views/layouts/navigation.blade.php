<nav x-data="{ open: false }" style="background-color: #ccfbf1;" class="dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 h-24">
            ...
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('images/logo.png') }}" alt="Logo" class="block h-9 w-100" />
                    </a>
                </div>
